    ...
    <footer className="bg-secondary mt-24">
      <div className="container mx-auto px-6 py-16">
        <div className="grid md:grid-cols-4 gap-12">
          <div>
            <h3 className="font-serif text-2xl mb-4">Valorie</h3>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <a href="#" aria-label="Twitter" className="hover:text-accent-foreground">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <Link to="/mode" className="hover:text-foreground">
                  Mode
                </Link>
              </li>
              <li>
                <Link to="/cosmetique" className="hover:text-foreground">
                  Cosmétique
                </Link>
              </li>
              <li>
        ...
        <div className="mt-16 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-muted-foreground">
          <p>© {new Date().getFullYear()} Valorie. Tous droits réservés.</p>
