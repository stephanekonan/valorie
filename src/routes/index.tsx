...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Maison Édène — L'art du raffinement" },
      { name: "description", content: "Découvrez la nouvelle collection mode et cosmétique de Maison Édène : élégance parisienne, beauté naturelle." },
    ],
  }),
  component: Index,
});
    ...
    <div>
        ...
        <div className="relative container mx-auto px-6 h-full flex items-center">
          <div className="max-w-xl fade-in-up">
            ...
            <h1 className="font-serif text-5xl md:text-7xl leading-[1.05] mb-6">
              L'élégance,<br />à fleur de peau.
            </h1>
            <p className="text-base md:text-lg text-foreground/80 mb-8 max-w-md">
              Une sélection raffinée de pièces mode et soins beauté, pensée pour celles et ceux qui cultivent la beauté du quotidien.
            </p>
      ...
      <section className="container mx-auto px-6 py-24">
        <div className="text-center mb-16">
          <p className="text-xs uppercase tracking-luxury text-muted-foreground mb-3">L'univers Édène</p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Link to="/mode" className="group block hover-zoom relative aspect-[4/5] overflow-hidden">
            <img src={modeImg} alt="Mode" loading="lazy" width={1024} height={1280} className="w-full h-full object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-foreground/40 to-transparent" />
            <div className="absolute bottom-0 left-0 right-0 p-8 text-background">
              <p className="text-xs uppercase tracking-luxury mb-2 opacity-80">Vêtements & accessoires</p>
              <h3 className="font-serif text-4xl mb-2">Mode</h3>
              <span className="text-sm border-b border-background pb-1">Découvrir →</span>
            </div>
          </Link>
          <Link to="/cosmetique" className="group block hover-zoom relative aspect-[4/5] overflow-hidden">
            <img src={cosmetiqueImg} alt="Cosmétique" loading="lazy" width={1024} height={1280} className="w-full h-full object-cover" />
            <div className="absolute inset-0 bg-gradient-to-t from-foreground/40 to-transparent" />
            <div className="absolute bottom-0 left-0 right-0 p-8 text-background">
              <p className="text-xs uppercase tracking-luxury mb-2 opacity-80">Soins & maquillage</p>
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="flex justify-between items-end mb-10">
          <div>
            <p className="text-xs uppercase tracking-luxury text-muted-foreground mb-2">Tout juste arrivé</p>
            <h2 className="text-3xl md:text-4xl">Nouveautés</h2>
          </div>
          <Link to="/mode" className="text-xs uppercase tracking-luxury border-b border-foreground pb-1 hidden sm:block">
            Voir tout
          </Link>
        </div>
      ...
      <section className="bg-secondary py-24 mt-16">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <p className="text-xs uppercase tracking-luxury text-muted-foreground mb-2">Vos préférés</p>
      ...
      <section className="container mx-auto px-6 py-24">
        <div className="grid md:grid-cols-3 gap-12 text-center">
          {[
            { t: "Beauté responsable", d: "Des formulations clean, des matières nobles, des partenaires choisis." },
            { t: "Livraison soignée", d: "Emballage éco-conçu, livraison offerte dès 80€ en France." },
            { t: "Conseil sur-mesure", d: "Notre équipe vous accompagne, du choix d'un produit à votre routine." },
          ].map((i) => (
            <div key={i.t}>
