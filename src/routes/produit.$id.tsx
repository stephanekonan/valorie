...
export const Route = createFileRoute("/produit/$id")({
  ...
  head: ({ loaderData }) => ({
    meta: [
      { title: loaderData ? `${loaderData.product.name} — Maison Édène` : "Produit" },
  ...
  notFoundComponent: () => (
    <div className="container mx-auto px-6 py-32 text-center">
      ...
      <Link to="/" className="text-xs uppercase tracking-luxury border-b border-foreground pb-1">Retour à l'accueil</Link>
    </div>
  ),
      ...
      <section className="container mx-auto px-6 grid lg:grid-cols-2 gap-12">
        ...
        <div className="lg:py-8">
          ...
          <div className="flex gap-3 mb-8">
            <button className="flex-1 bg-primary text-primary-foreground py-4 text-xs uppercase tracking-luxury hover:opacity-90 transition-opacity">
              Ajouter au panier
            </button>
            <button aria-label="Favoris" className="border border-border px-5 hover:border-foreground">
